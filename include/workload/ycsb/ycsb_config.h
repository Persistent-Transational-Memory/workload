...
#pragma once
#ifndef WORKLOAD_YCSB_CONFIG_H
#define WORKLOAD_YCSB_CONFIG_H
...
namespace workload {
	...
	inline namespace ycsb {
		...
		struct YCSBConfig<YCSBConfigType::A> {
			...
			static constexpr uint32_t READ_PERCENTAGE                      = 90;
			/// The property of write request.
			static constexpr uint32_t UPDATE_PERCENTAGE                    = 10;
